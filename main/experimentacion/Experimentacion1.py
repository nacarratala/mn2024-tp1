...
from Utilidad import matrizDeEnterosRandom, vectorDeEnterosRandom
...
# Los resultados se escriben en experimentacion1.txt. Esta conformado por dos columnas.
# La primera es el valor de n (dimension de la matriz), mientras que la segunda indica los ns que fueron necesarios
# para resolver el sistema
# Para la ejecucion de este test se recomienda tener la advertencia por error numerico desactivada
# ubicado en EliminacionGaussiana.py, para observar los resutlados mas fieles posibles
# ya que el print es una operacion costosa

RESULTS_TXT_FILE_NAME = "experimentacion/resultados/experimentacion1.txt"
WRITE_MODE = 'a'
ITERATION_COUNT = 10
...
def ejecutarParaDimension(n):
    matrizA = matrizDeEnterosRandom(n, 1, 50)
